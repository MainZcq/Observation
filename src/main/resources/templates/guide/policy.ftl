        ...
        <div class="row">
            <section class="col-md-3">
                <ul class="nav2" style="list-style:none">
                    ...
                    <li><a href="/news">新闻动态</a></li>
                    <li><a href="/notice" style="font-weight:bold">通知公告</a></li>
                    <li><a href="/policy">政策法规</a></li>
                    <li><a href="/work">中心工作</a></li>
                </ul>
            </section>
            <section class="col-md-8">
                <h2>&nbsp;&nbsp;政策法规</h2>
                <span style="float: right">当前位置&nbsp;：&nbsp;<a href="/"> 首页</a>&nbsp;>&nbsp;<a href="/news">新闻中心</a>&nbsp;>&nbsp;<a href="/policy">政策法规</a></span>
                ...
                <div style="text-align: center">
                    ...
                    <select name=select onchange="self.location.href=this.options[this.selectedIndex].value">
                        <option value="/policy" selected>第 1 页</option>
                    </select>
                </div>
