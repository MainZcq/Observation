        ...
        <div class="row">
            <section class="col-md-3">
                <ul class="nav2" style="list-style:none">
                    <li class="nav-title">新闻中心</li>
                    <li><a href="/news" style="font-weight:bold">新闻动态</a></li>
                    <li><a href="/notice">通知公告</a></li>
                    <li><a href="/policy">政策法规</a></li>
                    <li><a href="/work">中心工作</a></li>
                </ul>
            ...
            <section class="col-md-8">
                <h2>&nbsp;&nbsp;新闻动态</h2>
                <span style="float: right">当前位置&nbsp;：&nbsp;<a href="/"> 首页</a>&nbsp;>&nbsp;<a href="/news">新闻中心</a>&nbsp;>&nbsp;<a href="/news">新闻动态</a></span>
                ...
                <div style="text-align: center">
                    页次：2/2&nbsp;每页10&nbsp;总数15&nbsp;&nbsp;&nbsp;&nbsp;<a href="/news">首页</a>&nbsp;&nbsp;<a href="/news">上一页</a>&nbsp;&nbsp;下一页&nbsp;&nbsp;尾页&nbsp;&nbsp;&nbsp;&nbsp;转到:
                    <select name=select onchange="self.location.href=this.options[this.selectedIndex].value">
                        <option value="/news" >第 1 页</option>
                        <option value="/news2" selected>第 2 页</option>
                    </select>
                </div>
